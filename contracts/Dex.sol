...
contract Dex is ReentrancyGuard, Pausable{
    ...
    function getLatestPrice() public view returns (uint256) {
        ...
        uint256 CryptoToUSD = numerator / denominator;

        return CryptoToUSD;
    }

    function convertUSDToCrypto(uint256 _totalPrice)
        public
        view
        returns (uint256)
    {
        uint256 oneUSDToCryptoInWei = (1 * 10**18) / getLatestPrice();
        uint256 totalPriceInWei = oneUSDToCryptoInWei * _totalPrice;
